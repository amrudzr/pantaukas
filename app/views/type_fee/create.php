    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <h5 class="card-title mb-4">
                <i class="bi bi-plus-circle text-primary me-2"></i> Tambah Jenis Iuran
            </h5>

            <form method="POST" action="/fee/types/create">
                <!-- Nama Iuran -->
                <div class="mb-3">
                    <label for="name" class="form-label fw-semibold">Nama Iuran</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama jenis iuran" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="2" placeholder="Deskripsi jenis iuran"></textarea>
                </div>
...
<script>
    ...
    // Format nilai saat pertama kali load (jika ada nilai default)
